    ...
    <div class="main-container">
        ...
        <div class="form-container">
            <div class="login-card">
                ...
                <!-- Login Form -->
                <form method="POST" action="" class="login-form" style="<?php echo $showChangePasswordForm ? 'display: none;' : ''; ?>" autocomplete="off">
                ...
                <form method="POST" action="" class="change-password-form" style="<?php echo $showChangePasswordForm ? '' : 'display: none;'; ?>" autocomplete="off">
                    <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken); ?>">
                    <div class="input-group">
                        <input type="password" id="new_password" name="new_password" required oninput="validatePassword()" autocomplete="new-password">
                    ...
                    <div class="input-group">
                        <input type="password" id="confirm_password" name="confirm_password" required oninput="validatePassword()" autocomplete="new-password">
